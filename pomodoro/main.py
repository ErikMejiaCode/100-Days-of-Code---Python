...
def start_timer():
    ...
    if reps % 8 == 0:
        ...
        timer_label.config(text="Break", font=(FONT_NAME, 50), bg=YELLOW, fg=RED)
    elif reps % 2 == 0:
        countdown(short_break_sec)
        timer_label.config(text="Break", font=(FONT_NAME, 50), bg=YELLOW, fg=PINK)
    else:
        countdown(work_sec)
        timer_label.config(text="Work", font=(FONT_NAME, 50), bg=YELLOW, fg=GREEN)
...
#Checkmark
check_label = Label(font=(FONT_NAME, 36), bg=YELLOW, fg=GREEN)
